...
is given to yolo_model. The model is used to compute the output
is processed by yolo_head. It gives you
goes through a filtering function, yolo_eval. It outputs your predictions:
...
<ipython-input-45-4ee1c01d4438> in <module>()
----> 1 out_scores, out_boxes, out_classes = predict(sess, "test.jpg")

<ipython-input-44-22fbbe2855a2> in predict(sess, image_file)
...
<span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">The Drive.ai Sample Dataset</span> (provided by drive.ai) is licensed under a Creative Commons Attribution 4.0 International License. We are especially grateful to Brody Huval, Chih Hu and Rahul Patel for collecting and providing this dataset.
